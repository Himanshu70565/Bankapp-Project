...
<h1 class="text-center">Update customer</h1>
	<form:form action="updateCustomer" method="post" modelAttribute="customer" class="form">
	<form:hidden path="customerId"/>
		
		<div class="form-group">
				<label>Enter customer name</label>
				<form:input class="form-control" path="customerName" readonly="true"/>
				<form:errors path="customerName" class="error" />
		</div>
		
		<div class="form-group">
				<label>Enter customer email</label>
				<form:input class="form-control" path="customerEmail" readonly="true"/>
				<form:errors path="customerEmail" class="error" />
		</div>	
		
		<div class="form-group">
				<label>Enter customer phone number</label>
				<form:input class="form-control" path="customerPhone" readonly="true"/>
